...
Tokens help with user authentication, they are a secure way for the server to validate that a user has permission to access specific details that others aren't allowed to access.

- [ ] What steps can you take in your web apps to keep your data secure?

Protected routes and authentication help to keep user data secure when building sites.

- [ ] Describe how web servers work.

Web servers process incoming network requests over http.

- [ ] Which HTTP methods can be mapped to the acronym that we use when interfacing with APIs/Servers.
